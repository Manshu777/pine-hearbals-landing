<nav class="bg-white shadow-md sticky top-0 z-50">
      ...
      <div class="hidden md:flex space-x-8">
        ...
        <div class="relative group">
          ...
          <div class="absolute hidden group-hover:block bg-white shadow-lg rounded-md mt-2 w-48">
            <a href="/products/category1" class="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">Category 1</a>
            <a href="/products/category2" class="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">Category 2</a>
            <a href="/products/category3" class="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-600">Category 3</a>
          </div>
        </div>
  ...
  <div class="hidden md:hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1">
      ...
      <a href="/products/category1" class="block px-3 py-2 rounded-md text-gray-700 hover:bg-green-50 hover:text-green-600">Category 1</a>
      <a href="/products/category2" class="block px-3 py-2 rounded-md text-gray-700 hover:bg-green-50 hover:text-green-600">Category 2</a>
      <a href="/products/category3" class="block px-3 py-2 rounded-md text-gray-700 hover:bg-green-50 hover:text-green-600">Category 3</a>
