...
@section('content')
    <!-- Slider (Placeholder; replace with actual slider component if available) -->
    <x-slider />
    ...
    <!-- Products Carousel -->
    <x-products :categories="$categories" :products="$products" />


        @include('components.testimonial-slider', ['testimonials' => $testimonials])


            @include('components.blog-slider', ['blogs' => $blogs])
